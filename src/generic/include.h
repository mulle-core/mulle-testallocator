...
#ifdef MULLE__TESTALLOCATOR_BUILD
# define MULLE__TESTALLOCATOR_GLOBAL    MULLE_C_GLOBAL
#else
# if defined( MULLE_TESTALLOCATOR_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE_TESTALLOCATOR_INCLUDE_STATIC))
#  define MULLE__TESTALLOCATOR_GLOBAL   MULLE_C_EXTERN_GLOBAL
# else
#  define MULLE__TESTALLOCATOR_GLOBAL   extern
# endif
#endif
