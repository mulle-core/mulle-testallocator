...
#  define MULLE__ATEXIT_VERSION_MIN  ((0UL << 20) | (2 << 8) | 0)
# endif
# ifndef MULLE__ATEXIT_VERSION_MAX
#  define MULLE__ATEXIT_VERSION_MAX  ((0UL << 20) | (3 << 8) | 0)
# endif
...
#  define MULLE__ATINIT_VERSION_MIN  ((0UL << 20) | (3 << 8) | 2)
# endif
...
#  define MULLE__STACKTRACE_VERSION_MIN  ((0UL << 20) | (5 << 8) | 2)
# endif
